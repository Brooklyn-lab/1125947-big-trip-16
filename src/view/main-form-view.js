...
export const createMainFormTemplate = (point, buttonText, openButton) => {
  const { basePrice, dateFrom, dateTo, destination: { name, description, pictures }, offer: { type, offers } } = point;
