  ...
  return `<li class="trip-events__item">
      ...
      <div class="event__schedule">
        <p class="event__time">
            ...
            &mdash;
            <time class="event__end-time" datetime="${formatDate(dateTo, DAY_TIME_FORMAT)}">${formatDate(dateTo, TIME_FORMAT)}</time>
        </p>
        <p class="event__duration">${calculateDateDiff(dateFrom, dateTo)}</p>
      </div>
