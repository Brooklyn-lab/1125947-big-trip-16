import { TRIP_EVENT_TYPE, POINTS_NAMES } from '../../mock/task';
...
export const createMainFormTemplate = (point) => {
  ...
  const createTripEditTimeTemplate = (dateFromValue, dateToValue) => (`
  <div class="event__field-group  event__field-group--time">
    ...
    <input
      ...
      value="${formatDate(dateFromValue, DAY_TIME_FORMAT)}"
    >
    &mdash;
    <label
      class="visually-hidden"
    ...
    <input
      ...
      type="text"
      name="event-end-time"
      value="${formatDate(dateToValue, DAY_TIME_FORMAT)}"
    >
  </div>`
  );
